...
var _Delfino = {
    ...
    importCertificate:function(options, complete)
    {
        ...
        if(Delfino.getModule() !== "G4") options.moveImage = DC_get(DelfinoConfig.importImageUrl, Delfino.getModule());
    ...
    exportCertificate:function(options, complete)
    {
        ...
        if(Delfino.getModule() !== "G4") options.moveImage = DC_get(DelfinoConfig.exportImageUrl, Delfino.getModule());
    ...
    confirmSign:function(data, format, options, complete){
        ...
        if(DelfinoConfig.confirmSignTitleImageUrl != null && Delfino.getModule() !== "G4"){
            options.confirmSignTitleImage = DC_get(DelfinoConfig.confirmSignTitleImageUrl, Delfino.getModule());
        }
    ...
    login:function(data, options, complete)
    {
        ...
        options.cacheCert = true;
        $('#object_status_DelfinoG3').html("<span class='install_yes'>설치됨</span>");
        $('#object_download_DelfinoG3').hide();
//        this.sign(data, options, complete);
    },
    ...
    setModule:function(module){
        ...
        if(module == "G2" || module == "G3" || module == "G4" || module == "EA"){
            DC_setModule(module);
...
var DelfinoHandler = DelfinoHandler || (function(jQuery){
    ...
    var _delfino = {};
    var _parent = Delfino;
    var _parentFuncs = ["getKTBScanResult", "exportCertificate", "importCertificate", "signFileUrlDown", "signFileUrlSign", "signFileUrlUp", "verifySignFile", "signFile", "signFileUrl", "deleteCertificate", "setProperty", "resetCertificate", "loginForm", "sign","signData","addSigner","init","login","signForm","requestCertificate","requestCertificate2","updateCertificate","updateCertificate2","signKeyValue","multiSign","multiSignString","manageCertificate"];
